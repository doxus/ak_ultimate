...
\begin{minipage}{\textwidth}
	\question{%
		question={Architektura RISC charakteryzuje się:}%
	}{%
		isTrue1={Tak},%
		answer1={Niedużą liczbą trybów adresowania},%
		explain1={Cechą architektury RISC jest prostota. Wszystkie rozkazy posiadają jednakowy rozmiar i wystarcza minimalna liczba trybów adresowania.},%
		isTrue2={Nie},%
		answer2={Modelem obliczeń pamięć - pamięć},%
		explain2={Nie, ten model był stosowany w CISCach, które posiadały niewielką liczbę rejestrów ponieważ były droższe oraz obawiano się wzrostu czasu przełączania kontekstu.},%
		isTrue3={Nie},%
		answer3={Wykorzystaniem mikroprogramowalnych układów sterujących},%
		explain3={Takie układy były stosowane w CISCach. Jest to też rozwiązanie bardzo stare (początki w latach 50-tych).},%
		isTrue4={Tak},%
		answer4={Niezbyt obszerną listą rozkazów},%
		explain4={RISC dążył do uproszenie listy rozkazów, które w CISCach były ogromne i z większości się nie korzystało.},%
		isTrue5={Tak},%
		answer5={Intensywnym wykorzystaniem przetwarzania potokowego},%
		explain5={Był to jeden z kluczowych elementów sukcesu procesorów RISC.},%
	}
\end{minipage}
\begin{minipage}{\textwidth}
	\question{%
		...
		isTrue6={Nie},%
		answer6={Są otwierane przy występowaniu rozkazów rozgałęzień.}, %
		explain6={Są otwierane przy wywołaniu funkcji.}, %
	}
\end{minipage}
\begin{minipage}{\textwidth}
	\question{%
...
\begin{minipage}{\textwidth}
	\question{%
		question={Dla uniknięcia hazardu danych można:}%
	}{%
		isTrue1={Nie},%
		answer1={Zastosować uproszczone metody adresacji.},%
		explain1={RISC nie eliminuje hazardu XD Skracają tylko czas dostępu do pamięci.},%
		isTrue2={Tak},%
		answer2={Wykorzystać szynę zwrotną.},%
		explain2={Szyna zwrotna jest stosowana by zastosować "wyprzedzające pobieranie argumentów", które eliminuje prawdziwą zależność danych (RAW).},%
		isTrue3={Nie},%
		answer3={Zastosować specjalny bit w kodzie rozkazu.},%
		explain3={Jeden dodatkowy bicik nie sprawi, że argument będzie odczytany poprawnie.},%
		isTrue4={Nie},%
		answer4={Zastosować tablicę historii rozgałęzień.},%
		explain4={Ona eliminuje hazard sterowania.},%
		isTrue5={Tak},%
		answer5={Wstrzymać na 1 takt napełnianie potoku.},%
		explain5={Tak, to może wyeliminować antyzależność (WAR).},%
	}
\end{minipage}
\begin{minipage}{\textwidth}
	\question{%
...
\begin{minipage}{\textwidth}
	\question{%
		...
		isTrue5={Nie},%
		answer5={Jest stosowana do statycznego przewidywania rozgałęzień.},%
		explain5={Ona służy do dynamicznego przewidywania rozgałęzień. Początkowe strategie są statyczne, ale później zmieniają się w dynamiczne.},%
		isTrue6={Nie},%
		answer6={Pozwala zapamiętać całą historię wykonań każdego rozkazu rozgałęzienia.},%
		explain6={Tablica poświęca dla każdego rozkazu pewną skończoną liczbę bitów w celu przewidzenia rozgałęzienia.},%
	}
\end{minipage}
\begin{minipage}{\textwidth}
	\question{%
		...
		explain5={Nie, wstrzymywanie potoku mogą spowodować algorytmy zajmujące się eliminacją hazardu danych - zależności między argumentami.}, %
	}
\end{minipage}
\begin{minipage}{\textwidth}
	\question{%
...
\begin{minipage}{\textwidth}
	\question{%
		...
		explain3={},%
		isTrue4={Nie},%
		answer4={Sposób połączenia jednostek przetwarzających z modułami pamięci operacyjnej.},%
		explain4={},%
		isTrue5={Tak},%
		answer5={Liczba strumieni rozkazów i danych w systemach komputerowych},%
		explain5={To po prostu należy zapamiętać. \textbf{Kryterium klasyfikacji Flynna jest \emph{liczba strumieni rozkazów} oraz \emph{liczba strumieni danych} w systemie komputerowym. NIC WIĘCEJ, NIC MNIEJ.\\Albo inaczej: \emph{$Liczba\_strumieni\times(rozkazow+danych)$}}},%
	}
\end{minipage}
\begin{minipage}{\textwidth}
	\question{%
		...
		explain3={Tak jest \url{https://en.wikipedia.org/wiki/Cell_(microprocessor)}},%
		isTrue4={Tak},%
...
\begin{minipage}{\textwidth}
	\question{%
		...
		isTrue2={Tak},%
		answer2={Są charakterystyczne dla architektury SIMD},%
		explain2={Tak, z niej się zrodziły, tak samo jak m.in. technologie MMX i SSE.},%
		isTrue3={Nie},%
		answer3={Są rozkazami dwuargumentowymi i w wyniku zawsze dają wektor},%
		explain3={Nie, mogą operować na 1 argumencie na przykład. Rozkaz może być też 3 argumentowy, jak rozkaz dodawania VADD. Pierwszym argumentem jest rejestr docelowy, zawartość pozostałych dwóch jest dodana.},%
		isTrue4={Tak},%
		answer4={W komputerach wektorowych ich czas wykonania jest wprost proporcjonalny do długości wektora},%
		explain4={Tak, na przykładzie rozkazu dodawania wektorów widać, że czas rośnie równomiernie wraz z ilością elementów wektora.\\$t_{w}=t_{start}+(n-1)\times\tau$},%
		isTrue5={Nie},%
		answer5={W komputerach wektorowych ich czas wykonania jest liniowo zależny od długości wektora},%
		explain5={Tak, patrz wzór wyżej. Wyraźnie widać, że wraz ze wzrostem długości wektora, rozkaz dodawania wykonuje się dłużej o stałą wartość. Z kolei przepustowość (liczba operacji zmiennoprzecinkowych na sekundę) rośnie logarytmicznie wraz z długością wektora.},%
		isTrue6={Nie},%
		answer6={W komputerach macierzowych ich czas wykonania jest wprost proporcjonalny do liczby elementów przetwarzających},%
		explain6={Przy odpowiedniej liczbie jednostek przetwarzających jest stały},%
		isTrue7={Tak},%
		answer7={Mogą być wykonane na sieci elementów przetwarzających.},%
		explain7={Czyli na komputerze macierzowym - owszem.},%
	}
\end{minipage}
\begin{minipage}{\textwidth}
	\question{%
...
\begin{minipage}{\textwidth}
	\question{%
		question={Systemy wieloprocesorowe z jednorodnym dostępem do pamięci (UMA):}%
	}{%
		isTrue1={Tak},%
		answer1={Zapewniają spójność pamięci podręcznych wszystkich procesorów},%
		explain1={Czuwa nad tym protokół MESI, każdy uaktualnia stan pamięci w każdym z procesorów.},%
		isTrue2={Tak},%
		answer2={Mają niską skalowalność},%
		explain2={Mają wręcz chujową skalowalność, ponieważ przeważnie są połączone takimi konstrukcjami jak przełącznica krzyżowa czy wspólna magistrala, a sam mechanizm \emph{snoopingu} jest kiepsko skalowalny.},%
		isTrue3={Tak},%
		answer3={Wykorzystują katalog do utrzymania spójności pamięci.},%
		explain3={Tak, wg wykładów Kozielskiego UMA może wykorzystywać do kontroli pamięci spójnej zarówno katalog, jak i protokół MESI.},%
		isTrue4={Nie},%
		answer4={Wykorzystują przesył komunikatów między procesorami.},%
		explain4={To cecha MPP oraz klastrów.},%
		isTrue5={Tak},%
		answer5={Umożliwiają dostęp do pamięci najczęściej poprzez wspólną magistralę lub przełącznicę krzyżową.},%
		explain5={Są to jednego z możliwych konfiguracji UMA, są to najprostsze i najtańsze rozwiązania, więc prawdopodobnie też najczęściej stosowane (ale również najmniej skalowalne).},%
	}
\end{minipage}
\begin{minipage}{\textwidth}
	\question{%
...
\begin{minipage}{\textwidth}
	\question{%
		...
		explain1={Wiadomo, że katalog jest wykorzystywany do zachowania spójności tego rodzaju pamięci, która jest wspólna (L2). L1 jest pamięcią prywatną rdzenia, więc nie ma potrzebny zachowywać jej spójności.},%
		isTrue2={Tak},%
...
\begin{minipage}{\textwidth}
	\question{%
		...
		explain1={Nie, to rozwiązanie sieci połączeń w architekturze UMA. Mało wydajna.},%
		isTrue2={Tak},%
		answer2={Katalogu},%
		explain2={To mechanizm do zachowania spójności jaki stosowany jest głównie w architekturze NUMA, ale UMA też może.},%
		isTrue3={Tak},%
		answer3={Protokołu MESI},%
		explain3={Tak, i tylko to do tego służy. Wykorzystuje do wyłącznie architektura UMA.},%
		isTrue4={Nie},%
		answer4={Wspólnej magistrali},%
		explain4={Nie, jest to jeden z rodzajów połączeń w architekturze UMA, ale nie ma nic wspólnego ze spójnością pamięci jej procków.},%
	}
\end{minipage}
\begin{minipage}{\textwidth}
	\question{%
...
\begin{minipage}{\textwidth}
	\question{%
		question={Systemy pamięcią rozproszoną (MPP):}%
	}{%
		isTrue1={Tak},%
...
\begin{minipage}{\textwidth}
	\question{%
		...
		isTrue1={Tak},%
		answer1={Mechanizm \emph{mirroringu} dysków},%
		...
		explain4={Tak, gdy ten mechanizm przestaje odbierać "bicie serca" jednego z węzłów, wówczas może wywołać procedurę obsługi - przenieść zadania do innego węzła, włączyć powiadomienie itp.},%
		isTrue5={Nie},%
...
\begin{minipage}{\textwidth}
	\question{%
		question={Sieci systemowe (SAN)}%
	}{%
		isTrue1={Nie},%
		answer1={Wymagają protokołu MESI},%
		explain1={Sieci to tylko kabel, nie mają wymagań co do zarządzania pamięcią XD},%
		isTrue2={Tak},%
		answer2={Wykorzystują przełączniki łączone wg topologii grubego drzewa},%
		explain2={Topologię grubego drzewa wykorzystuje np. InfiniBand, która jest siecią łączącą w klastrach znajdujących się w komputerach top500.},%
		isTrue3={Tak},%
		answer3={Realizują przesyły bloków danych bezpośrednio między pamięciami operacyjnymi węzłów sieci},%
		explain3={Sieci SAN posiadają sterowniki DMA, czyli mogą przesyłać dane bezpośrednio między pamięciami, a same dane przesyłane są w pakietach, czyli jakichś blokach.},%
		isTrue4={Tak},%
		answer4={Są stosowane w klastrach},%
		explain4={Tak, łączą węzły z systemami.},%
	}
\end{minipage}
\begin{minipage}{\textwidth}
	\question{%
...
\begin{minipage}{\textwidth}
	\question{%
		...
		explain2={Jest coś takiego jak wielowątkowość drobnoziarnista, która przełącza wątki co takt.},%
		isTrue3={Nie},%
...
\begin{minipage}{\textwidth}
	\question{%
		question={Sprzętowe sterowanie wielowątkowością:}%
	}{%
		isTrue1={Tak},%
		answer1={Zapewnia lepsze wykorzystanie potoków.},%
		explain1={Tak, ma na celu minimalizację problemów, jakie stwarza przetwarzanie potokowe, jak hazard sterowania, zależności między rozkazami oraz chybione odwołania do pamięci.},%
		isTrue2={Tak},%
		answer2={Wymaga zwielokrotnienia zasobów procesora (rejestry, liczniki rozkazów i inne)},%
		explain2={Tak, aby móc wykonać sterować wątkami na poziomie sprzętu potrzeba więcej sprzętu.},%
		isTrue3={Nie},%
		answer3={Nie może być stosowane w przypadku hazardu sterowania},%
		explain3={To sterowanie służy właśnie minimalizacji start powstałych m.in. z hazardu sterowania.},%
		isTrue4={Tak},%
		answer4={M.in. minimalizują straty wynikające z chybionych odwołań do pamięci podrecznej},%
		explain4={Patrz wyżej.},%
	}
\end{minipage}
\begin{minipage}{\textwidth}
	\question{%
		question={Dostęp każdego procesora do wspólnej pamięci operacyjnej jest realizowany w systemach:}%
	}{%
		isTrue1={Tak},%
		answer1={NUMA},%
		explain1={W NUMA pamięć jest rozdzielona fizycznie, ale logicznie wspólna. Wszystkie procesory mają do niej dostęp.},
		isTrue2={Tak},%
		answer2={SMP},%
		explain2={Wszystkie modele SMP, jak UMA, NUMA czy CC-NUMA posiadają pamięć logicznie wspólną.},
		isTrue3={Nie},%
		answer3={Klaster},%
		explain3={Pamięć jest logicznie rozproszona, każdy węzeł(czyli system) posiada swoją.},
		isTrue4={Nie},%
		answer4={MPP},%
		explain4={Pamięć jest logicznie rozproszona, każdy węzeł (procesor albo system UMA / NUMA) posiada swoją.},
	}
\end{minipage}
\begin{minipage}{\textwidth}
	\question{%
		...
		isTrue1={Nie},%
		answer1={Są niezbędne do realizacji rozkazów wektorowych.},%
		explain1={Nie, o ile wiele rdzeni może umożliwić wykonywanie rozkazów wektorowych, to warunkiem koniecznym do wykonywania rozkazów wektorowych jest istnieje wielu jednostek przetwarzających w dowolnej postaci.},
		isTrue2={NieWiem},%
		answer2={Tworzą systemy wieloprocesorowe ze wspólną pamięcią i jednorodnym dostępem do pamięci.},%
		explain2={Tak, mogą one tworzyć system wieloprocesorowy (z rdzeniami), ale pamięć CHYBA nie musi być wspólna o jednorodnym dostępie (no bo chyba każdy rdzeń może mieć własną.)??},
		isTrue3={Tak},%
		answer3={Są niezbędne do współbieżnego przetwarzania wątkowego.},%
		explain3={Tak, jest to konieczne aby realizować współbieżnie wiele wątkóW w obrębie jednego procesora.},
		isTrue4={NieWiem},%
		answer4={Wymagają kontroli spójności pamięci podręcznych.},%
		explain4={Każdy rdzeń posiada pamięć podręczną L1, która jest prywatna oraz pamięć podręczną L2, która jest publiczna. Do L2 inne rdzenie mogą się odnosić poprzez magistralę i występuje problem spójności cache'u.},
	}
\end{minipage}
